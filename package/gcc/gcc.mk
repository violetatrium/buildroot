...
# Disable libsanitizer due to a build issue with gcc 9.2 and glibc 2.31.
...
# but it conflict with gcc 9.2 libsanitizer code.
# Disable libsanitizer since the gcc 9.2 branch is now closed
# (unmaintained) and it's not a trivial merge.
ifeq ($(BR2_TOOLCHAIN_BUILDROOT_GLIBC)$(BR2_GCC_VERSION_9_X),yy)
